...
const SOURCE_ID = "source-jch-109-result";
const SOURCE_URL = "https://www.jaaf.or.jp/files/upload/202508/25_115843.pdf";
const BATCH_DATE = "20260710";
const SOURCE_DIR = path.resolve("data/imports/japanese-championships-5000m-109-source");
...
const LOCAL_CACHE_PDF_PATH = path.resolve("data/imports/jch-2025-resultall.pdf");
...
const SECTION_DEFINITIONS: SectionDefinition[] = [
  {
    key: "800-heat-1",
    raceSlug: "japanese-championships-5000m-109-men-800-heat-1",
    sourceEntityPrefix: "jch109-men-800-heat1",
    title: "男子800m 予選1組",
  },
  {
    key: "800-heat-2",
    raceSlug: "japanese-championships-5000m-109-men-800-heat-2",
    sourceEntityPrefix: "jch109-men-800-heat2",
    title: "男子800m 予選2組",
  },
  {
    key: "800-heat-3",
    raceSlug: "japanese-championships-5000m-109-men-800-heat-3",
    sourceEntityPrefix: "jch109-men-800-heat3",
    title: "男子800m 予選3組",
  },
  {
    key: "800-final",
    raceSlug: "japanese-championships-5000m-109-men-800-final",
    sourceEntityPrefix: "jch109-men-800-final",
    title: "男子800m 決勝",
  },
  {
    key: "1500-heat-1",
    raceSlug: "japanese-championships-5000m-109-men-1500-heat-1",
    sourceEntityPrefix: "jch109-men-1500-heat1",
    title: "男子1500m 予選1組",
  },
  {
    key: "1500-heat-2",
    raceSlug: "japanese-championships-5000m-109-men-1500-heat-2",
    sourceEntityPrefix: "jch109-men-1500-heat2",
    title: "男子1500m 予選2組",
  },
  {
    key: "1500-final",
    raceSlug: "japanese-championships-5000m-109-men-1500-final",
    sourceEntityPrefix: "jch109-men-1500-final",
    title: "男子1500m 決勝",
  },
  {
    key: "3000sc-final",
    raceSlug: "japanese-championships-5000m-109-men-3000sc-final",
    sourceEntityPrefix: "jch109-men-3000sc-final",
    title: "男子3000mSC 決勝",
  },
];
...
const PERSON_SLUG_OVERRIDES = new Map<string, string>([
  ...
  ["塩原 匠", "person-kanaguri2026-e5a1a9e58e9fe58ca0"],
  ["前田 陽向", "person-e5898de794b020e999bde590"],
  ["ｸﾚｲ ｱｰﾛﾝ 竜波", "clay-allon-tatsunami"],
  ["兵藤 ｼﾞｭﾀﾞ", "hyodo-juda"],
]);
...
>([
  ...
  ["SAURUS TC", { slug: "org-kanaguri2025-5341555255535443", nameJa: "SAURUSTC", type: "club" }],
  ["宮城陸協", { slug: "miyagi-rikukyo", nameJa: "宮城陸協", type: "club" }],
  ["スマイス", { slug: "smyth", nameJa: "スマイス", type: "club" }],
  ["IIIF", { slug: "yakuodo-iiif", nameJa: "薬王堂IIIF", type: "corporate_team" }],
  ["lllF", { slug: "yakuodo-iiif", nameJa: "薬王堂IIIF", type: "corporate_team" }],
...
function inferOrganizationType(label: string): OrgType {
  ...
  if (/(AC|RC|クラブ|TC|G|Lab|State|陸協)$/i.test(normalized)) {
    return "club";
  }
...
function resolvePersonSlug(
  ...
  return fallbackSlug("person-jch109-mid", name);
}
...
function resolveOrganization(
  ...
  return {
    slug: fallbackSlug("org-jch109-mid", normalized),
    nameJa: normalized,
...
async function buildPayload(
  ...
  return raceImportPayloadSchema.parse({
    ...
    summary: `第109回日本陸上競技選手権大会 ${section.title} JAAF公式結果PDF import`,
