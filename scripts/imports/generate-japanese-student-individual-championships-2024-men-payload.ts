...
const SOURCE_ID = "source-japanese-student-individual-championships-2024-results";
const BATCH_DATE = "20260709";
const SOURCE_DIR = path.resolve("data/imports/japanese-student-individual-championships-2024-source");
...
const RACE_DEFINITIONS: RaceDefinition[] = [
  {
    raceSlug: "japanese-student-individual-championships-2024-men-800-heat-1",
    displayName: "男子800m 予選1組",
    discipline: "m800",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-800-heat-1",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel021.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-800-heat-2",
    displayName: "男子800m 予選2組",
    discipline: "m800",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-800-heat-2",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel022.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-800-heat-3",
    displayName: "男子800m 予選3組",
    discipline: "m800",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-800-heat-3",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel023.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-800-final",
    displayName: "男子800m 決勝",
    discipline: "m800",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-800-final",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel137.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-1500-final",
    displayName: "男子1500m 決勝",
    discipline: "m1500",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-1500-final",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel024.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-5000-final",
    displayName: "男子5000m 決勝",
    discipline: "m5000",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-5000-final",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel025.html",
  },
  {
    raceSlug: "japanese-student-individual-championships-2024-men-3000sc-final",
    displayName: "男子3000mSC 決勝",
    discipline: "m3000sc",
    sourceEntityPrefix: "japanese-student-individual-championships-2024-men-3000sc-final",
    url: "https://www.iuau.jp/ev2024/24kosen/res/rel037.html",
  },
];
...
function resolveOrganization(label: string, lookup: Awaited<ReturnType<typeof loadOrganizationLookup>>) {
  ...
  return {
    slug: fallbackSlug("org-jusic2024", normalizedLabel),
...
function resolvePersonSlug(
  ...
  if (candidates.length === 0) {
    return fallbackSlug("person-jusic2024", `${organizationSlug}-${displayNameJa}`);
  }
...
async function buildPayload(
  ...
  return raceImportPayloadSchema.parse({
    ...
    summary: `2024日本学生陸上競技個人選手権大会 ${definition.displayName} IUAU公式結果HTML import`,
    pbNotes: "IUAU公式HTML結果ページ。PB/SB表記はソースにないため反映していない。Q/DNSなどの公式コメントはnotesに反映した。男子10000mは2024年大会では実施されていない。",
    entries,
  });
}
