...
async function main() {
  ...
  const summaryPath = path.resolve(summaryArg ?? "data/imports/high-school-ekiden-2022-men/summary.json");
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.auditLog.create({
        data: {
          ...
          reasonNote: "Backfilled prefecture from national high school ekiden 2022 men prefecture representative",
