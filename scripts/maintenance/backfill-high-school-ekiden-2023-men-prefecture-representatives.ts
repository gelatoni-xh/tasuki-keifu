...
async function main() {
  ...
  const summaryPath = path.resolve(summaryArg ?? "data/imports/high-school-ekiden-2023-men/summary.json");
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.auditLog.create({
        data: {
          ...
          reasonNote: "Backfilled prefecture from national high school ekiden 2023 men prefecture representative",
